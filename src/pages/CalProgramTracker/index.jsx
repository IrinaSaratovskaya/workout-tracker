...
const CalProgramTracker = (props) => {   

    const [popupSaveProgram, setPopupSaveProgram] = useState(false);
    const [exercises, setExercises] = useState([
        {name: 'asdf', sets: [{reps: 10, comment: 'qwer'}]},
    ...
    return (
        <main className="page-wrapper d-flex justify-content-center">
            <PageTop 
                pageDescription="Tracking your workouts can be the perfect way to encourage you to keep on keepin’ on. With an intuitive interface, Workout Tracker lets you track and log all the details of your workouts."
            > 
...
export default withRouter(CalProgramTracker);